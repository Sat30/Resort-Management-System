...
lottie_coding = load_lottieurl(
    "https://assets5.lottiefiles.com/packages/lf20_k6yihqmi.json"
)
st_lottie(lottie_coding, height=200, key="delete logo")
st.write("---")


st.markdown(
"""<h1 style='text-align: center;background-color: lightblue'>Deletion</h1>""",    unsafe_allow_html=True,
)
st.write("---")
...
# DELIMITER $$
# CREATE FUNCTION ratef(rate decimal(1))
# RETURNS VARCHAR(50)
# DETERMINISTIC
# BEGIN
# IF rate < 3 THEN
