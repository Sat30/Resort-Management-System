...
lottie_coding = load_lottieurl(
   "https://assets9.lottiefiles.com/packages/lf20_XAsbOIEMrI.json"
)
...
st.markdown(
    """<h1 style='text-align: center;background-color: lightblue'>Insert into Database</h1>""",
...
if option == "Customer":
    with st.form(key="insert_form_cust"):
        ...
        st.markdown(
             """<h1 style='text-align: center;background-color: lightyellow'>Resort Info</h1>""",
            unsafe_allow_html=True,
        )
